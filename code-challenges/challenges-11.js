...
function gradesAvg(arr) {
    ...
    // let newList = arr.map(i => Object.assign({}, i, {avg:avg(i.gradsList)}));
       return newList;
}
...
function studentsResult(arr) {
    // let newList = arr.map(i => Object.assign({}, i, {result:arr.avg>50}));
    let newList= arr.map(obj=> ({ ...obj, result: check(obj.avg) }))
